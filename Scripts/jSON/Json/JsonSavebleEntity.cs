...
namespace Donchesster.Saving
{
    [ExecuteAlways]
    public class JsonSavebleEntity : MonoBehaviour
    {
    
        [SerializeField] string uniqueIdentifier = "";

        // CACHED STATE
        static Dictionary<string, JsonSavebleEntity> globalLookup = new Dictionary<string, JsonSavebleEntity>();
